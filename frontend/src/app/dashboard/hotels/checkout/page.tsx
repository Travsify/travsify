...
import { Hotel, User, Mail, Phone, CreditCard, ChevronLeft, Loader2, CheckCircle2, ShieldCheck, Info, Calendar, Users, MapPin } from 'lucide-react';
    ...
    try {
      const res = await fetch(`${API_URL}/api/v1/checkout`, {
        ...
        body: JSON.stringify({
          ...
          providerData: {
            hotelId: hotelId,
            guests: [{ firstName: guest.firstName, lastName: guest.lastName }],
      ...
      if (data.status === 'success') {
        setMessage(data.message || 'Hotel reservation completed successfully!');
        setSuccess(true);
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center animate-in fade-in zoom-in duration-700">
        ...
        <h1 className="text-4xl font-black text-slate-900 tracking-tight">Hotel Reserved!</h1>
        <p className="text-slate-500 max-w-md mx-auto mt-4 text-lg">
          {message || 'Your hotel reservation has been successfully processed and confirmed.'}
        </p>
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 pb-20">
      <div className="flex items-center gap-6">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Hotel Checkout</h1>
          <p className="text-sm text-slate-400 font-medium mt-1">Review your stay details and provide guest information.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-10">
          ...
          <section className="bg-white p-10 rounded-[40px] border border-slate-200 shadow-xl shadow-slate-100/50 space-y-8 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <h2 className="text-xl font-black text-slate-900 tracking-tight">Guest Information</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Special Requests</label>
                <textarea 
        ...
        <div className="space-y-6">
          <div className="bg-[#0A1629] text-white p-8 rounded-[40px] shadow-2xl shadow-blue-900/20 space-y-8 sticky top-10">
            <div className="space-y-2">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Accommodation</p>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center">
                  <Hotel size={20} className="text-[#FF6B00]" />
                </div>
                <div>
                  <p className="text-sm font-black tracking-tight">Premium Property</p>
                  <p className="text-[10px] font-bold text-slate-400 flex items-center gap-1"><MapPin size={10} /> Verified Listing</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 border-t border-white/10 pt-6">
              <div className="flex justify-between items-center">
                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Stay Duration</span>
                <span className="text-sm font-black">Nights TBD</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Property Taxes</span>
            ...
            >
              ...
              {loading ? 'Confirming Stay...' : 'Book Property'}
            </button>
