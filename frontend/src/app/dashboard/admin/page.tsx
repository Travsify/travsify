         ...
         <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-12">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-[11px] font-black text-orange-500 uppercase tracking-[0.3em]">System Health: Excellent</span>
              </div>
              ...
              <p className="text-slate-400 font-bold text-lg max-w-xl">
                Managing your entire travel empire. Currently overseeing {tenants.length} active business partners worldwide.
              </p>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
               <StatMetric label="Total Sales" value="$2.4M" trend="+14%" />
               <StatMetric label="Active Users" value={tenants.length.toString()} trend="Live" />
               <StatMetric label="Platform Uptime" value="100%" trend="Optimal" />
            </div>
         </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-slate-900 rounded-[32px] border border-white/5 p-10 flex flex-col justify-between shadow-xl relative overflow-hidden group">
           ...
           <div>
             ...
             <h3 className="text-xl font-black text-white mb-6 tracking-tight">Booking Connections</h3>
             <div className="space-y-3">
               <PulseItem label="Flight Engine" status="Online" latency="82ms" />
               <PulseItem label="Hotel Engine" status="Online" latency="145ms" />
               <PulseItem label="Payments" status="Online" latency="11ms" />
               <PulseItem label="User Accounts" status="Online" latency="430ms" />
             </div>
           </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-[32px] border border-slate-200 overflow-hidden shadow-sm flex flex-col">
           <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
             <div>
               ...
               <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Manage your business partners and users</p>
             </div>
             <div className="flex items-center gap-3">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-100">
                    <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Business Partner</th>
                    <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Status</th>
                    <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Services</th>
      ...
      <div className="bg-slate-900 rounded-[32px] border border-white/5 p-12 shadow-2xl relative overflow-hidden">
         ...
         <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex-1 space-y-6 relative z-10">
               <h3 className="text-2xl font-black text-white tracking-tight">Profit & Markup Settings</h3>
               <p className="text-slate-400 font-medium max-w-lg leading-relaxed">
                 Manage how much you earn on every booking. Your current average profit margin across all services is <span className="text-orange-500 font-black">4.5%</span>.
               </p>
               <div className="flex gap-4">
                  <div className="px-6 py-5 bg-white/5 border border-white/10 rounded-2xl flex-1">
                     <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Flight Profit</p>
                     <p className="text-2xl font-black text-white tracking-tight">3.0%</p>
                  </div>
                  <div className="px-6 py-5 bg-white/5 border border-white/10 rounded-2xl flex-1">
                     <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Hotel Profit</p>
            ...
            <div className="flex-none w-full lg:w-[420px] relative z-10">
               <div className="p-10 bg-orange-600 rounded-[32px] shadow-2xl shadow-orange-600/30">
                  <h4 className="text-white font-black text-xl mb-6 tracking-tight">Admin Controls</h4>
                  <div className="space-y-4">
